            ...
            <div className='projectCardContainer'>
                {
                    ...
                    Object.keys(selfprojects).map(item => (
                        <div className='projectCard' key={item}>
                            ...
                            <div>{(selfprojects as any)[item].pages.length} {(selfprojects as any)[item].pages.length > 1 ? 'páginas' : 'página'}</div>
                        </div>
                    ))
                }
                {
                    docs?.map((pages, index) => (
                        <div className='projectCard' key={pages.id}>
                            ...
                            <div>{pages.pages.length} {pages.pages.length > 1 ? 'páginas' : 'página'}</div>
                        </div>
                    ))
                }
            </div>
